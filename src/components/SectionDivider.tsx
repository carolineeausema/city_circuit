...
export default function SectionDivider({ color, number }: SectionDividerProps) {
  return (
    ...
    <div className="w-full bg-white flex items-center justify-center">
      <div className="w-full max-w-[1100px] px-6 relative">
        ...
        <div className="absolute left-0 right-0 bottom-0 h-px" style={{ backgroundColor: color }} />

        {/* Left end dots (three small dots) */}
        <div className="absolute left-0 bottom-0 flex items-center space-x-1 -translate-y-1/2 pl-1">
        ...
        <div className="absolute right-0 bottom-0 flex items-center space-x-1 -translate-y-1/2 pr-1">
          <span className="w-2 h-2 rounded-full" style={{ backgroundColor: color, opacity: 0.7 }} />
          <span className="w-2 h-2 rounded-full" style={{ backgroundColor: color, opacity: 0.85 }} />
          <span className="w-2 h-2 rounded-full" style={{ backgroundColor: color }} />
        </div>
